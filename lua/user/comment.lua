...
local status_integrations_ok, integrations = pcall(require, 'ts_context_commentstring.integrations.comment_nvim')
if not status_integrations_ok then
  return
end

comment.setup {
  pre_hook = integrations.create_pre_hook(),
